...
$$ V=\int_0^L\frac{Mt(L-x)}{2LI}g_{31}ndx $$
 ...
 An alternative design, should magnetic/piezo integration prove infeasible, is to measure the tilt of magnetic cilia  by some other means. Millimeter-wave radar could detect changes in tilt angle, similar to the techniques used in vital-signs radar \cite{li2013review}. This design can be pursued in parallel as a risk reduction task.
...
\begin{tabularx}{.85\textwidth}{|X||c|c|X|}
    ...
    \hline
    Fabrication unreliable & 3 & 5 & Begin fabrication early, so process can be adjusted. \\
    \hline
