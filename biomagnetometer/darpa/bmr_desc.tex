...
University of Florida (UF), Gainesville, FL has state-of-the-art laboratory facilities in many fields of engineering and science. The University strives to conduct frontier research in broad range of disciplines including engineering, science, medicine, agriculture, education and related disciplines, and provides the nation and its industries with highly qualified graduates.  
...
\begin{description}
\item[BEN 200 and NEB 500] The IMG computer lab is located in 200 Benton (BEN) Hall and is for engineering design and simulation. Also, an additional simulation lab in the ECE department is located in New Engineering Building (NEB) 500. Available software includes following:
\begin{itemize}
\item PSpice (OrCAD Inc.)  
\item Multiphysics simulation tool COMSOL package (COMSOL Inc.)  
\item High frequency structure simulator (HFSS, Ansys, Inc.) 
\item Designer (Ansys, Inc.)
\item 50 Linux and SUN systems 
\item Agilent high frequency simulation package (EmPro)
\end{itemize}
\item[BEN 214 and NEB 500] Electronic characterization facility:
\begin{itemize}
\item Impedance Analyzer (HP 4194)   
\item Parameter Analyzer  
\item Power meter, Spectrum Analyzer, Oscilloscope, Digital multimeter, Power supply 
\item Vector Network Analyzer (Agilent, E5071E) (3 kHz ~ 20 GHz) 
\item Probe Station
\item Vector Network Analyzer (E8361A, Agilent, Inc.) (50 MHz ~ 110 GHz)
\item Probe Station (Cascade Microtech)
\end{itemize}
\item[Major Analytical Instrumentation Center (MAIC)]:
\begin{itemize} 
\item Auger Spectroscopy (Perkin-Elmer PHI 660) 
\item XPS (Perkin Elmer 5100 XPS System) 
\item Focused Ion Beam (FIB Dual-Beam Strata DB235) 
\item Scanning Electron Microscopes (FEI XL-40 FEG-SEM, JEOL 6335F FEG-SEM, JEOL SEM-6400, JEOL SEM-6400 2) 
\item Scanning Probe Microscopy (SPM/AFM Dimension 3100, SPM/AFM Multimode Nanoscope III) 
\item Surface Metrology (Veeco Wyko NT 1000 Profiler) 
\item Transmission Electron Microscope (JEOL 200CX TEM, JEOL 2010F TEM) 
\item TriboIndenter (Hysitron TriboIndenter) 
\item X-Ray Diffraction (Philips APD 3720, Phlips HT APD 3720, Philips XPert MRD)
\end{itemize}
\end{description}

The Nanoscale Research Facility (NRF) is a multi-user oriented class 100-1000 cleanroom facility that provides nanofabrication and characterization equipment to the scientific community at the University of Florida. The cleanroom features a bay-and-chase layout with seven different research bays, including e-beam lithography, bio/nano biological, photolithography, wet processing, hot processing, thin film deposition, and dry etching bays.  Additionally, electroplating systems for copper and ferromagnetic materials and high temperature furnace (Linderburg) are available in BEN 230 and 237C.

Major device fabrication equipment includes:
\begin{description}
\item[Lithography]:
 
\begin{itemize}
\item Raith-150 electron beam direct write lithography system 
\item Deep UV photolithography system 
\item EVG 620 back-side aligner/wafer bonder 
\item Karl Suss MA6, MJB3 aligners 
\item EVG501 wafer bonder 
\end{itemize}

\item[Deposition]:
 
\begin{itemize}
\item STS 310PC PECVD  
\item KJL multi-target sputtering system 
\item E-beam and thermal evaporators 
\end{itemize}

\item[Furnaces]:
 
\begin{itemize}
\item Tystar LPCVD, oxidation, polysilicon, and diffusion furnaces  
\item Heatpulse 2100 RTA  
\item Steag 100CS RTP 
\end{itemize}

\item[Etching]:
 
\begin{itemize}
\item STS ASE deep reactive ion etcher  
\item Unaxis RIE-ICP  
\item Plasma Sciences RIE 
\item Anatech SCE600 asher 
\end{itemize}

\item[Backend]:
 
\begin{itemize}
\item Dicing saws, wire-bonders, and die bonding apparatus 
\end{itemize}

\item[Metrology]:
 
\begin{itemize}
\item Lakeshore 7507 Hall effect magnetic measurement system 
\item Tencor and Dektak profilometers  
\item Nanometrics Nanospec 
\item Prometrix wafer resistivity mapper 
\item J.A. Woolam ellipsometer 
\item Probe stations, resistivity probes, CV analyzer, inspection probes
\end{itemize}
